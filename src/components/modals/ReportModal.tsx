    ...
    <>
      ...
      >
        ...
        <ModalContent>
          ...
          <ModalBody>
            <Text fontWeight="600">
              Help us understand the issue. What’s wrong with this NFT?
            </Text>
            <Stack my="4" color="red.500">
              <Checkbox>Explicit or adult sexual content</Checkbox>
              <Checkbox>
                Copyright infringement (the person who posted it doesn’t own it)
              </Checkbox>
            ...
            <FormControl>
              <FormLabel>
                Add any details that will help us evaluate the problem.
              </FormLabel>
              <Textarea />
            </FormControl>
